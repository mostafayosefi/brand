@component('admin.layouts.content', [
    'title' => $subcategorybrand->name,
    'tabTitle' => $subcategorybrand->name,
    'breadcrumb' => [
        ['title' => 'لیست دسته بندی برند    ', 'url' => route('admin.categorybrand.index')],
        ['title' => $subcategorybrand->categorybrand->name , 'url' => route('admin.categorybrand.show' , $subcategorybrand->categorybrand->id )],
        ['title' => 'ویرایش '.$subcategorybrand->name,
    'class' => 'active']],
    ])
                      ...
                      <div class="card">
                          <div class="card-body">
                              ...
                              <div class="card-header card-header-border-bottom">
                                  <h4> ویرایش زیردسته {{$subcategorybrand->name}} </h4>
                              </div>
                              ...
                              <form class="forms-sample" method="POST" action="{{ route('admin.categorybrand.sub.update', $subcategorybrand) }}"
                                      ...
                                      <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name" autocomplete="off"
                                                placeholder="نام دسته بندی برند" name="name" value="{{$subcategorybrand->name}}">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control"  autocomplete="off"
                                                placeholder="توضیحات" name="text"  id="tinymceExample" rows="8"
                                                 >{{$subcategorybrand->text}}</textarea>
                                        </div>
                                          ...
                                          <div class="card-footer">
                                              <a href="{{  route('admin.categorybrand.show' , $subcategorybrand->categorybrand->id ) }}" class="btn btn-danger">بازگشت</a>
