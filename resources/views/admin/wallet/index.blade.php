          ...
          <div class="table-responsive">
            ...
            @foreach($wallets as $key => $admin)
                <tr>
                    ...
                    <td> <a href="{{ route('admin.wallet.show', $admin) }}"> @include('index.layouts.table.getstatus', [$admin ,'route' => ''  ,'type_name' => 'flag_wallet'   ]) </a> </td>
                    <td>{{ date_frmat($admin->created_at) }}</td>
                    <td> <a href="{{ route('admin.wallet.show', $admin) }}"> @include('index.layouts.table.getstatus', [$admin ,'route' => '' ,'type_name' => 'status_wallet'   ]) </a> </td>
                </tr>
            @endforeach
